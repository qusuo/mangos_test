...
/** \addtogroup u2w User to DBServer Communication
 * @{
 * \file DBServerSocket.h
 * \author Derex <derex101@gmail.com>
 */

#ifndef _GATEWAYSOCKET_H
#define _GATEWAYSOCKET_H
 ...
 *
 * The calls to Update () method are managed by DBServerSocketMgr
 * and ReactorRunnable.
 *
...
class DBServerSocket : public MaNGOS::Socket
{
    private:
#if defined( __GNUC__ )
#pragma pack(1)
