...
/// \addtogroup gateway Mangos Daemon
/// @{
/// \file
...
char serviceName[] = "gateway";
char serviceLongName[] = "MaNGOS gateway service";
...
#include "dbserver/MasterDBServer.h"


//DatabaseType WorldDatabase;                                ///< Accessor to the gateway database
//DatabaseType CharacterDatabase;                             ///< Accessor to the character database
//DatabaseType LoginDatabase;                                 ///< Accessor to the realm/login database
DatabaseType WorldDatabase;                                 ///< Accessor to the realm/login database
...
int main(int argc, char *argv[])
{
	...
	desc.add_options()
		("config,c", boost::program_options::value<std::string>(&configFile)->default_value(_GATEWAY_CONFIG), "configuration file")
		("help,h", "prints usage")
	...
	sLog.outString("%s [gateway-daemon]", _FULLVERSION(REVISION_DATE, REVISION_TIME, REVISION_ID));
	...
	sLog.outString("\n\n"
		...
		"     | |_____| |	\n"
		"      \\______//   \n"
		"      http://www.u8wan.com     Doing things right!\n\n");
	...
	// 0 - normal shutdown
	// 1 - shutdown at error
	// 2 - restart command used, this code can be used by restarter for restart gateway
}
