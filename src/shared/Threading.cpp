...
void Thread::setPriority(Priority priority)
{
    ...
    switch (priority)
    {
        case Priority_Realtime: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_TIME_CRITICAL); break;
		case Priority_Highest: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_HIGHEST);       break;
		case Priority_High: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_ABOVE_NORMAL);  break;
		case Priority_Normal: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_NORMAL);        break;
		case Priority_Low: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_BELOW_NORMAL);  break;
		case Priority_Lowest: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_LOWEST);        break;
		case Priority_Idle: _ok = (bool)SetThreadPriority(handle, THREAD_PRIORITY_IDLE);          break;
    }
