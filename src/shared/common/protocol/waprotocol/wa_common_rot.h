...
namespace waprot
{
	...
	{
		WARoleLogin()
			:header(USER_LOGIN_INFO_WA, SERVER_NODE_TYPE_GLOBAL, prot::SS_MSG_TYPE_SYS)
		{
		}
	...
	{
		WARoleLogout()
			:header(USER_LOGOUT_WA, SERVER_NODE_TYPE_GLOBAL, prot::SS_MSG_TYPE_SYS)
			, role_id(0)
		{
		}
	...
	{
		WARoleAttrChange()
			:header(USER_INFO_CHANGE_WA, SERVER_NODE_TYPE_GLOBAL, prot::SS_MSG_TYPE_SYS)
			, role_id(0)
			, attr_type(0)
			, attr_value(0)
		{
	...
	{
		WARoleSyncInfo()
			:header(USER_SYNC_INFO_WA, SERVER_NODE_TYPE_GLOBAL, prot::SS_MSG_TYPE_SYS)
			, role_id(0)
			, silent_end_time(0)
		{
		}
